...
# -*- coding: utf-8 -*-
"""
Created on Wed Feb 21 10:57:09 2024
...
class NestedUNet(nn.Module):
    def __init__(self, num_classes=1, input_channels=3, deep_supervision=False, num_filter = 32, **kwargs):
        super().__init__()
...
# # torch.save(model.state_dict(),'unet_plus_plus_naveen.pth')
# # #%%
# # import re
